...
var validIcons = allIcons['default'] || allIcons;

_iconsVue2['default'].add.apply(_iconsVue2['default'], (0, _toConsumableArray3['default'])(Object.keys(validIcons).map(function (key) {
